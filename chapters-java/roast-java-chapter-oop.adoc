...
* `final class` = no subclasses, inheritance is forbidden. It is useful to create unmodifable objects.
====
...
* What is a marker interface? * What is use of a marker interface?
